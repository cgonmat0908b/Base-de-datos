...
-- Transacción fallida por error tecnico
CALL insertar_pedido_seguro(1,100, "ABCD", 15, 15.23);

-- Transacción que no falle
CALL insertar_pedido_seguro(5,2000, "FR-67", 5, 70);
...
/*Desarrolla un procedimiento llamado realizar_pago_con_stock que reciba:
 código de cliente, ID de transacción, importe del pago, código de producto y cantidad comprada.
 
 Requisitos:

- Transaccionalidad: Debe asegurar que si el pago se registra, eproductol stock se descuente, y viceversa.
